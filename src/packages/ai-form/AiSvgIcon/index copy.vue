<template>
  <i v-if="isShowIconSvg" class="el-icon" :style="setIconSvgStyle">111
    <component :is="getIconName" />
  </i>
  <div v-else-if="isShowIconImg" :style="setIconImgOutStyle">222
    <img :src="getIconName" :style="setIconSvgInsStyle" />
  </div>
  <i v-else :class="getIconName" :style="setIconSvgStyle" >333>
</template>
