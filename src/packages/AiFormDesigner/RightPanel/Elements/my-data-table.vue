<template>
  ...
  <el-form-item v-if="props.data['show-summary'] !== undefined" label="列配置">
    <el-button @click="state.showColConfig = true" icon="Edit"> 编辑...</el-button>
  </el-form-item>
    ...
    <el-table :data="props.data.cols"  >
      ...
      <el-table-column fixed="right" label="操作" width="120">
        <template #default="scope">
          ...
          <el-button circle type="primary" size="small" icon="Plus" @click.prevent="addRow(scope.$index)">  </el-button>
         
          <el-button circle type="danger" size="small" icon="Minus" @click.prevent="deleteRow(scope.$index)">  </el-button>
        </template>
      </el-table-column>
    </el-table>
  </el-dialog>
