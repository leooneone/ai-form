...
import { a as E } from "./index-5c589461.js";
...
const N = pe(), be = { style: { padding: "0px 0px 8px 8px", width: "100%" } }, ge = { class: "my-flex" }, ve = { class: "ml10 my-flex-fill my-flex-y-center" }, ye = m({
  ...
  setup(e, { emit: t }) {
    ...
    K();
    const c = Q(() => import("./file-upload-81d02c08.js")), i = S(), l = P({
      loading: !1,
      fileFormTitle: "",
...
const ke = /* @__PURE__ */ E(he, [["__scopeId", "data-v-8de4a2af"]]), $e = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: ke
